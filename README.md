...
in Windows: ``C:\Users\USERNAME\Synfig\plugins``,
in OSX: ``/Users/USERNAME/Library/Synfig/plugins``.
...
More information on using plugins is available from the official [Scribus documentation](https://synfig.readthedocs.io/en/latest/plugins.html#how-to-install-plugins).
