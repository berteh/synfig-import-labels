...
TEMPLATE_NAME = "descending-text"	# the name of template you want to use. must be located in templates/ subdirectory, with .xml extension. default is "simple-text"
ANIMATION_INTERVAL = 0.3		# interval (before and after the label time) used for transition, in seconds. default is 0.5
RANDOM_ORIGIN = 80			    # set to a percentage [0-100] to randomize the object origin in the whole document viewbox (0 will stack them all at [0,0])
WAYPOINT_TYPE = "clamped"			# one of: constant, auto, linear, clamped, halt
VALUE_BEFORE = "-1.0"			
VALUE_MIDDLE = "0.0"
VALUE_AFTER = "1.0"
